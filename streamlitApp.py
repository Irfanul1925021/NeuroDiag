...
#We are using streamlit to build web application for our DL based project
...
st.set_page_config(page_title="NeuroDiag", page_icon=":camera:")
...
st.header("NeuroDiag: A Brain Tumor Detection Algorithm")
st.write(
